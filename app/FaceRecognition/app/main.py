...
async def get_model():
    ...
    if match_count / len(rafal_trzaskowski_embeddings) > 0.7:
    ...
    if match_count / len(daniel_obajtek_embeddings) > 0.7:
        is_daniel_obajtek_face = True

    print("Rafał Trzaskowski")
    print(is_rafal_trzaskowski_face)
    print("Daniel Obajtek")
    print(is_daniel_obajtek_face)



#PROBLEM
#FileNotFoundError: [Errno 2] No such file or directory: '/kaggle/input/fake-ads-face-recognition/fake_ads/'

# RESNET MODEL TOO BIG - DOWNLOAD IT FROM GOOGLE DRIVE SEPERATELY


# REMEMBER!!!!!!!!!
# RESNET MODEL TOO BIG - DOWNLOAD IT FROM GOOGLE DRIVE SEPERATELY AND DROP TO app DIRECTORY